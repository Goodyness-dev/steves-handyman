...
export default function Footer({ onOpenWizard, onNavigate }) {
  ...
  return (
    <footer className="bg-onyx-950 text-neutral-400 text-sm pb-16 sm:pb-0 border-t border-neutral-900" role="contentinfo">
      
      {/* High-Impact Pre-footer Bar */}
      <div className="bg-black py-12 px-4 sm:px-6 lg:px-8 border-b border-neutral-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 w-full md:w-auto shrink-0">
            <button
              ...
              className="px-8 py-4 rounded-full bg-white text-black font-heading font-black text-xs sm:text-sm tracking-wider uppercase hover:bg-neutral-200 transition shadow-2xl active:scale-95"
            >
              REQUEST A QUOTE ↗
            </button>
            <a
              href={`tel:${BUSINESS_INFO.phone.replace(/[^0-9]/g, '')}`}
              className="px-7 py-4 rounded-full bg-white/10 hover:bg-white/20 text-white font-heading font-bold text-xs sm:text-sm tracking-wider uppercase border border-white/20 transition flex items-center gap-2.5 active:scale-95"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-heading font-black text-white text-base tracking-wider uppercase ml-1">
              STEVE'S HANDYMAN
            </span>
          </div>
          ...
          <div className="text-xs text-emerald-400 font-semibold flex items-center gap-2 pt-2">
            ...
            {[
              ...
              <li key={link.label}>
                <button 
                  ...
                  className="hover:text-white transition text-neutral-400 hover:underline text-left"
                >
                  {link.label}
                </button>
              </li>
        ...
        <div className="space-y-3">
          ...
          <div className="text-xs text-neutral-400 space-y-2">
            <p className="text-white font-bold">{BUSINESS_INFO.legalName}</p>
            <p>{BUSINESS_INFO.address.formatted}</p>
            <p className="pt-1 font-bold text-white">Call Steve: {BUSINESS_INFO.phone}</p>
      ...
      {/* Copyright Bar */}
      <div className="border-t border-neutral-900 py-6 px-4 text-center text-xs text-neutral-600">
